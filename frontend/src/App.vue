<template>
  <div id="app">
    ...
    <aside class="layout-sidebar">
      <div class="logo-area">
        <img src="/logo-banner.png" alt="Glumoo - 小红书宠物图文Agent" class="logo-icon" />
      </div>
      ...
      <div style="margin-top: auto; padding-top: 20px; border-top: 1px solid var(--border-color);">
        <div style="display: flex; align-items: center; gap: 10px;">
          <div style="width: 36px; height: 36px; border-radius: 50%; background: linear-gradient(135deg, var(--primary) 0%, #ff6b6b 100%); display: flex; align-items: center; justify-content: center; color: white; font-weight: 600; font-size: 14px;">G</div>
          <div>
            <div style="font-size: 14px; font-weight: 600;">glumoo</div>
          </div>
        </div>
      </div>
    </aside>
        ...
        <footer v-if="route.path !== '/'" class="global-footer">
          <div class="footer-content">
            ...
            <div class="footer-text">
              © 2025 <a href="#" target="_blank" rel="noopener noreferrer">Glumoo</a> 宠物图文Agent
            </div>
